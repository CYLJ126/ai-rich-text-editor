...
import com.nip.app.api.rbac.AbstractSecurityService;
import com.nip.app.api.rbac.TokenService;
import com.nip.app.common.constant.RbacConstant;
import com.nip.app.pojo.rbac.JwtUserDto;
...
public class TokenServiceImpl extends AbstractSecurityService implements TokenService {
    ...
    public String createToken(Authentication authentication) {
        return JWT.create()
                .setPayload(RbacConstant.NIP_USER_NAME, authentication.getName())
                .setKey(key)
                .sign();
    }
