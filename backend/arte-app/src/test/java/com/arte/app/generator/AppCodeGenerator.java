package com.arte.app.generator;
...
public class AppCodeGenerator {
     ...
     * 数据库信息
     */
    private static final String url = "jdbc:mysql://bj-cynosdbmysql-grp-dex4oraw.sql.tencentcdb.com:25501/arte?serverTimezone=Asia/Shanghai&characterEncoding=utf8&useSSL=false&allowPublicKeyRetrieval=true";
    private static final String username = "arte_prod";
    private static final String password = "C201@0bee-08c0eb43d606";

    /**
     * 要生成代码的表名列表，不填就会生成所有的！！！！！
     */
//    private static final List<String> tables = List.of("arte_base_tag", "arte_base_summary", "arte_dw_statistics", "arte_dw_weekly_work", "arte_dw_daily_work", "arte_dw_steps", "arte_dw_weekly_days");
    private static final List<String> tables = List.of("arte_ai_assistant");
     ...
     * 表示项目的模块名称
     */
    private static final String module = "arte-ai";
    /**
     * 文件输出路径
     */
     ...
     * 忽略的表名前缀
     */
    private static final String[] prefixesIgnore = new String[]{"arte_", "arte_dw_", "arte_rbac_", "arte_ai_", "arte_home_"};
    /**
     * 忽略的表名后缀
     */
     ...
     * 父包的名称
     */
    private static final String parent = "com.arte.ai";
    /**
     * 模块名称
     */
