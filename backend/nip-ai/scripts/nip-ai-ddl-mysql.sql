...
create index idx_nip_ai_assistant_main
    on nip_ai_assistant (create_by, status, name(50), update_time);

create table nip_ai_conversation
(
    id                  int auto_increment comment '主键'
        primary key,
...
create index idx_create_by_status_time
    on nip_ai_conversation (create_by asc, status asc, last_message_at desc);

create table nip_ai_conversation_memory
(
...
create index idx_ai_conversation_user_id
    on nip_ai_conversation_memory (user_id);

create table nip_ai_conversation_summary
(
...
create index idx_conv_id
    on nip_ai_conversation_summary (conv_id);

create table nip_ai_message
(
    id                int auto_increment comment '主键'
        primary key,
...
create index idx_branch_id
    on nip_ai_message (branch_id);

create index idx_conv_id
    on nip_ai_message (conv_id, create_time);

create index idx_create_info
    on nip_ai_message (create_by, create_time);

create index idx_parent_message_id
    on nip_ai_message (parent_message_id);

create table nip_ai_message_attachment
(
    id            bigint auto_increment comment '主键'
        primary key,
...
create index idx_conv_id
    on nip_ai_message_attachment (conv_id);

create index idx_create_by
    on nip_ai_message_attachment (create_by);

create index idx_message_id
    on nip_ai_message_attachment (message_id);

create table nip_ai_message_raw_log
(
...
create index idx_conv_msg
    on nip_ai_message_raw_log (conv_id, message_id);

create index idx_create_time
    on nip_ai_message_raw_log (create_time);

create index idx_provider_model
    on nip_ai_message_raw_log (provider, model_id);

create index idx_trace_id
    on nip_ai_message_raw_log (trace_id);

create table nip_ai_model_config
(
    id                     int auto_increment comment '主键'
        primary key,
...
fulltext index ft_model_search
    on nip_ai_model_config (model_name, model_id);

create index idx_model_type
    on nip_ai_model_config (model_type);

create index idx_provider_type_status
    on nip_ai_model_config (provider, model_type, status);


create table nip_ai_prompt_template
(
...
create index idx_ai_prompt_stage
    on nip_ai_prompt_template (stage);

create table nip_ai_token_usage
(
    id               bigint auto_increment comment '主键'
        primary key,
...
create index idx_model_date
    on nip_ai_token_usage (model_id, usage_date);

create index idx_user_date
    on nip_ai_token_usage (user_name, usage_date);
