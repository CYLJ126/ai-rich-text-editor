...
import com.nip.ai.advisor.*;
import com.nip.ai.api.BackEndChatService;
...
import com.nip.ai.mcp.server.NipMcpTools;
import com.nip.ai.pojo.EditMessageRequestDto;
import com.nip.ai.pojo.RegenerateRequestDto;
import com.nip.ai.pojo.chat.ChatRagRequestDto;
import com.nip.ai.pojo.chat.ChatRequestDto;
import com.nip.ai.pojo.chat.ChatRequestParam;
...
import com.nip.ai.tool.RequestParamHandler;
...
public class BackEndChatServiceImpl implements BackEndChatService {
    ...
    @Resource
    private NipMcpTools nipMcpTools;
