...
import com.nip.ai.config.McpConfig;
 ...
 *
 * @author CYLJ126 ≧◔◡◔≦
 * @since 2026/8/26 17:05 ✾
 **/
@Slf4j
@Service
public class NipMcpTools {

    private final static List<String> lastNameList = List.of(
            ...
            "钟离", "宇文", "长孙", "慕容", "鲜于", "闾丘", "司徒", "司空", "亓官", "司寇", "仉督", "子车", "颛孙", "端木", "巫马", "公西",
            "漆雕", "乐正", "壤驷", "公良", "拓跋", "夹谷", "宰父", "谷梁", "晋楚", "闫法", "汝鄢", "涂钦", "段干", "百里", "东郭", "南门",
            "呼延", "归海", "羊舌", "微生", "岳帅", "缑亢", "况后", "有琴", "梁丘", "左丘", "东门", "西门", "商牟", "佘佴", "伯赏", "南宫",
            "墨哈", "谯笪", "年爱", "阳佟", "第五", "言福");
    ...
    /**
     * 打印传输参数
     * 参数设置见 {@link McpConfig#transport()}
     *
     * @param requestContext 请求上下文
     */
    private void printTransportParams(McpSyncRequestContext requestContext) {
        if (ObjectUtil.hasNull(requestContext, requestContext.transportContext())) {
