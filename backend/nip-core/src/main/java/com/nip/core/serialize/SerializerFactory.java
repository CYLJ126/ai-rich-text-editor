...
public class SerializerFactory {
    ...
    public static JsonMapper buildJsonMapperWithTypeProperty() {
        return buildJsonMapper(true, "com.nip.", true, DefaultTyping.NON_FINAL_AND_RECORDS, "@class", "yyyy-MM-dd HH:mm:ss");
    }

    public static JsonMapper buildJsonMapperWithoutTypeProperty() {
        return buildJsonMapper(true, "com.nip.", false, DefaultTyping.JAVA_LANG_OBJECT, null, "yyyy-MM-dd HH:mm:ss");
    }
