export default {
  ...
  'app.article.table.copyTable': '复制表格',
  'app.article.table.cutTable': '剪切表格',
  'app.article.table.copyTableAsMarkdown': '复制为 Markdown',
  'app.article.table.deleteTable': '删除表格',
  'app.article.table.copyTableSuccess': '表格已复制',
  'app.article.table.copyTableAsMarkdownSuccess': 'Markdown 已复制',
  'app.article.table.clipboardError': '无法写入剪贴板',
  'app.article.table.tableStyle': '表格样式',
  'app.article.table.stripedRows': '隔行底色',
  'app.article.table.headerColored': '表头着色',
  'app.article.table.borderStyle': '边框样式',
  'app.article.table.borderAll': '所有边框',
  'app.article.table.borderHorizontal': '横向边框',
  'app.article.table.borderVertical': '竖向边框',
  'app.article.table.borderNone': '无边框',
  'app.article.table.cellDensity': '单元格间距',
  'app.article.table.densityCompact': '紧凑',
  'app.article.table.densityNarrow': '微窄',
  'app.article.table.densityStandard': '标准',
  'app.article.table.densityWide': '微宽',
  'app.article.table.densitySpacious': '宽松',
  'app.article.table.cellBackgroundColor': '单元格背景色',
  'app.article.table.clearCellBackground': '清除背景色',
  'app.article.table.selectCellForBackground': '请先将光标放入或选中目标单元格',
  ...
  'app.article.article.richtexteditor.cf9fa79d': '导出',
