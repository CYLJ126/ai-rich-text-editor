export default {
  ...
  'app.article.table.horizontalAlignment': '水平對齊',
  'app.article.table.alignLeft': '靠左對齊',
  'app.article.table.alignCenter': '置中對齊',
  'app.article.table.alignRight': '靠右對齊',
  'app.article.table.verticalAlignment': '垂直對齊',
  ...
  'app.article.table.copyTable': '複製表格',
  'app.article.table.cutTable': '剪下表格',
  'app.article.table.copyTableAsMarkdown': '複製為 Markdown',
  'app.article.table.deleteTable': '刪除表格',
  'app.article.table.copyTableSuccess': '表格已複製',
  'app.article.table.copyTableAsMarkdownSuccess': 'Markdown 已複製',
  'app.article.table.clipboardError': '無法寫入剪貼簿',
  'app.article.table.tableStyle': '表格樣式',
  'app.article.table.stripedRows': '隔行底色',
  'app.article.table.headerColored': '表頭著色',
  'app.article.table.borderStyle': '邊框樣式',
  'app.article.table.borderAll': '所有邊框',
  'app.article.table.borderHorizontal': '橫向邊框',
  'app.article.table.borderVertical': '直向邊框',
  'app.article.table.borderNone': '無邊框',
  'app.article.table.cellDensity': '儲存格間距',
  'app.article.table.densityCompact': '緊湊',
  'app.article.table.densityNarrow': '微窄',
  'app.article.table.densityStandard': '標準',
  'app.article.table.densityWide': '微寬',
  'app.article.table.densitySpacious': '寬鬆',
  'app.article.table.cellBackgroundColor': '儲存格背景色',
  'app.article.table.clearCellBackground': '清除背景色',
  'app.article.table.selectCellForBackground': '請先將游標放入或選取目標儲存格',
  ...
  'app.article.editor.richtextcontext.d7355ca6': '文本顏色【Mod-Shift-X】',
  ...
  'app.article.sidebar.articlesummary.9e7f2eed': '總結字數上限',
  ...
  'app.article.article.richtexteditor.hideSideMenu': '隱藏左側菜單',
  'app.article.article.richtexteditor.showSideMenu': '顯示左側菜單',
