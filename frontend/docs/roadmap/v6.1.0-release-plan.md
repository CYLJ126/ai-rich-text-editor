...
|---------------------|------------------------------------------------|------------------------------------------------------|
| ProTable page       | `src/pages/list/table-list/ArticleTags.tsx`    | Data loading, search, pagination, CRUD operations    |
| Dashboard           | `src/pages/dashboard/analysis/ArticleTags.tsx` | Chart rendering, layout, chart data flow             |
| Basic form          | `src/pages/form/basic-form/ArticleTags.tsx`    | Form validation, submission, field interactions      |
