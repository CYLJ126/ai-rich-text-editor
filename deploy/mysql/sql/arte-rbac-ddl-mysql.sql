...
-- auto-generated definition
create table if not exists arte_rbac_menu_operation
(
    id             int auto_increment comment 'ID'
        primary key,
...
-- auto-generated definition
create table if not exists arte_rbac_relation
(
    id           int auto_increment comment 'ID'
        primary key,
...
-- auto-generated definition
create table if not exists arte_rbac_role
(
...
-- auto-generated definition
create table if not exists arte_rbac_user
(
    id          int auto_increment comment '主键'
        primary key,
