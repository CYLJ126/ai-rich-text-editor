...
create table if not exists arte_base_tag
(
...
create table if not exists arte_base_tag_relation
(
    id        int auto_increment comment '主键'
        primary key,
...
create table if not exists arte_base_summary
(
    id        int auto_increment comment '主键'
        primary key,
...
CALL add_index_if_not_exists(
    'arte_base_summary',
    'content',
    'create fulltext index content on arte_base_summary (content)'
);

create table if not exists arte_dw_sticky
(
